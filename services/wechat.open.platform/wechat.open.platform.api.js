...
const __FAST_REGISTER_MINI_PROGRAM__ = 'https://api.weixin.qq.com/cgi-bin/account/fastregister?access_token=%s';
const __GET_ACCOUNT_BASIC_INFO__ = 'https://api.weixin.qq.com/cgi-bin/account/getaccountbasicinfo?access_token=%s';
...
module.exports = {
    ...
    __FAST_REGISTER_MINI_PROGRAM__: __FAST_REGISTER_MINI_PROGRAM__,
    __GET_ACCOUNT_BASIC_INFO__: __GET_ACCOUNT_BASIC_INFO__
};